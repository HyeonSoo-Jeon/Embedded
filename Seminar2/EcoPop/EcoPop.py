...
# series[:200].diff().diff().dropna().plot()
# print(series[:200].mean())
# 24406
model1 = ARIMA(series[:200], order=(0, 0, 0), seasonal_order=(0, 1, 0, 12))
...
series.plot()
model_fit1.predict(start=2, end=282).plot(label='SARIMA(0, 0, 0)(0, 1, 0, 12)')
