...
plt.axvline(x=pd.datetime(2021, 12, 1), color='r', linestyle='--', linewidth=1)
plt.axvline(x=pd.datetime(2021, 12, 23),
...
fig, ax1 = plt.subplots()
plt.xticks(rotation=45)
ax1.scatter(df4['ds'], df4['y'], color='green', label='S', s=10)
ax2 = ax1.twinx()
ax2.scatter(df4['ds'], df4['H'], color='blue', label='H', s=10)
# plt.legend(['S', 'H'], loc="best")
plt.axvline(x=pd.datetime(2021, 12, 1), color='r', linestyle='--', linewidth=1)
plt.axvline(x=pd.datetime(2021, 12, 23),
            color='r', linestyle='--', linewidth=1)
